                ...
                if (white) {
                    for (let tile in document.getElementsByClassName('tile')) {
                        ...
                        if (_tile.firstChild != null) {
                            // @ts-ignore
                            if (_tile.firstChild.style.backgroundImage == 'url("src/pages/images/wK.png")') {
                                _tile.style.backgroundImage = 'url("src/pages/images/check.png")';
                    ...
                    for (let tile in document.getElementsByClassName('tile')) {
                        ...
                        if (_tile.firstChild != null) {
                            // @ts-ignore
                            if (_tile.firstChild.style.backgroundImage == 'url("src/pages/images/bK.png")') {
                                _tile.style.backgroundImage = 'url("src/pages/images/check.png")';
                                king.current = _tile.id
                            }
                        }
            ...
            function handlePossibleMoves(moves: string[]) {
                for (let i = 0; i < moves.length; i++) {
                    ...
                    if (tile.firstChild != null) {
                        tile.style.backgroundImage = `url("src/pages/images/dot_piece.png")`
                    } else {
                        tile.style.backgroundImage = `url("src/pages/images/dot.png")`
                    }
                }
                ...
                <div>
                    ...
                    <div className='captured-container'>
                        {OpponentCapturedPieces.map((piece) => (<div className='captured' style={{
                            backgroundImage: `url("src/pages/images/${piece}.png")`,
                            width: '30px',
                            height: '30px'
